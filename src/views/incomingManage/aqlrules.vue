    ...
    <div class="p-2">
        <el-card shadow="always" :body-style="{ padding: '8px' }">
            ...
            <el-table :data="tableData.slice(
                ...
                <el-table-column prop="PriorityCodeName" :label="$t('aqlrules.partNumber')" />
                <el-table-column prop="ProductName" :label="$t('aqlrules.supplier')" />
                <el-table-column prop="Description" :label="$t('aqlrules.sampleInStand')" />
        ...
        <el-dialog :title="$t('publicText.add')" v-model="addVisible" width="500px" @close="addCancel">
            <el-form :model="addForm" ref="addFormRef" label-width="auto" :inline="false" size="normal">
                ...
                <el-form-item :label="$t('aqlrules.supplier')" prop="supplier">
                    <el-input v-model="addForm.supplier"></el-input>
                </el-form-item>
                <el-form-item :label="$t('aqlrules.sampleInStand')" prop="sampleInStand">
                    <el-input v-model="addForm.sampleInStand"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog :title="$t('publicText.edit')" v-model="editVisible" width="500px" @close="editCancel">
            <el-form :model="editForm" ref="editFormRef" label-width="auto" :inline="false" size="normal">
                ...
                <el-form-item :label="$t('aqlrules.sampleInStand')" prop="sampleInStand">
                    <el-input v-model="editForm.sampleInStand"></el-input>
                </el-form-item>
            </el-form>
            <template #footer>
