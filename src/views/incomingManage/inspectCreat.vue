<template>
    <div class="p-2">
        <el-card :body-style="{ padding: '8px' }">
            <div class="flex justify-between">
                <el-form ref="formRef" :model="getForm" :inline="true" label-width="auto" size="small">
                    ...
                    <el-form-item :label="$t('incomeCreat.creatDate')" class="mb-2"><el-date-picker
        ...
        <el-dialog v-model="creatEditVisible" :title="$t('incomeCreat.creatEditInspectCode')" width="750px"
            :append-to-body="true" :close-on-click-modal="false" :close-on-press-escape="false" align-center
