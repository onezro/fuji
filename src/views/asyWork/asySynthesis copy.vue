      ...
      <div class="w-[calc(100%-370px)]">
        ...
        <div class="w-full h-full flex flex-col">
          <div>
            ...
            <div class="h-[180px] pt-3 pr-5 pl-5 flex justify-between">
              <div>
              ...
              <div>
                <el-table :data="barData" size="small" border :row-class-name="tableRowClassName" :height="160">
...
// import { OrderQuery,QueryMoveHistory } from "@/api/dipApi";
import {
  OrderQuery,
  QueryMoveHistory,
  QueryAssemblyKeyMaterial,
  JudgeAssemblyKeyMaterial,
  AssemblySynthesisMoveStd,
} from "@/api/asyApi";
