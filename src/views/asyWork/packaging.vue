<template>
    <div class="flex flex-col w-full h-full">
        <div class="h-[40px] min-h-[40px] pl-2 pr-2 flex justify-between items-center">
            <span class="text-lg"> {{ opui.stationDec }} </span>
            <div></div>
        </div>
        <div class="w-full flex-1 flex">
            <div class="setwidth w-[350px]">
                <div class="w-full h-full box">
                    <div class="h-[30px] flex items-center text-lg text-[#fff] bg-[#006487]">
                    ...
                    <div class="p-[10px]">
                        <el-form class="inbound" ref="formRef" :model="form" label-width="auto">
                            ...
                            <el-form-item v-for="f in formHeader" :key="f.value" :label="f.label">
                                <span class="font-bold text-base leading-[30px]"
                        ...
                        <div class="h-[150px] pt-3 pr-5 pl-5">
                            <el-form class="inbound" ref="formRef" :inline="true" :model="form" label-width="auto"
                                ...
                                <el-form-item label="批次时间">
                                    <el-date-picker v-model="boxForm.date" value-format="YYYY-MM-DD"
                                        :disabled-date="disabledDate" style="width: 160px" type="date" placeholder="" />
                                </el-form-item>
                                <el-form-item label="外箱号"> 
                                    <el-input v-model="boxForm.wxh" style="width: 160px" placeholder="" disabled/>
                                </el-form-item>
                                <el-form-item label="箱容量"> 
                                    <el-input v-model="boxForm.qty" style="width: 160px" placeholder="" disabled/>
                                </el-form-item>
                                <el-form-item label="已装箱"> 
                                    <el-input v-model="boxForm.yz" style="width: 160px" placeholder="" disabled/>
                                </el-form-item>
                                ...
                                <el-form-item>
                                    <el-button type="primary">不满箱装箱</el-button>
                                </el-form-item>
                            </el-form>
...
const getOrderData = () => {
    ...
    OrderQuery({ lineName: opui.line, OrderTypeName: "asyApi" }).then(
        (res: any) => {
