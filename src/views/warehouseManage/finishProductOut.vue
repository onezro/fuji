<template>
    <div class="p-2">
        <el-card shadow="always" :body-style="{ padding: '8px' }">
            ...
            <el-table :data="tableData" size="small" ref="excelTableRef" :style="{ width: '100%' }" :height="tableHeight" border stripe>
...
const getData = () => {
    ...
    GetFinishedNewQuery(getForm.value).then((res: any) => {
        if (res.success) {
