  ...
  <div class="flex flex-col w-full h-full">
              ...
              <div class="flex flex-col gap-2">
                ...
                >
                  <img
                    ...
                    src="@/assets/img/dbl.png"
                    class="ml-10"
                  />
                  <span
                    class="underline cursor-pointer"
                    @click="openOrderDialog(0)"
                    >待备料（{{ toBePrepared.length }}）</span
                  >
                </div>
                <div
                  class="flex items-center gap-4 p-1 border border-solid border-[#f0b06f]"
                >
                  <img
                    alt=""
                    style="width: 40px; height: 40px"
                  ...
                  <span
                    class="underline cursor-pointer"
                    @click="openOrderDialog(1)"
                    >备料中（{{ preparation.length }}）</span
                  >
                </div>
                <div
                  class="flex items-center gap-4 p-1 border border-solid border-[#09bb07]"
                >
                  <img
                    alt=""
                    style="width: 40px; height: 40px"
                  ...
                  <span
                    class="underline cursor-pointer"
                    @click="openOrderDialog(2)"
                    >备料完成（{{ preComplete.length }}）</span
                  >
                </div>
              </div>
            </el-form>
          ...
          <div>
            ...
            <div class="h-[130px] pt-3 pr-2 pl-2 overflow-auto">
              ...
              >
                ...
                >
                  <el-input
                    v-model="operateForm.OrderNumber"
                    style="width: 200px"
                ...
                >
                  <el-input
                    v-model="operateForm.OrderPlanedQty"
                    style="width: 200px"
                    disabled
                  />
                </el-form-item>
                ...
                >
                  <el-input
                    v-model="operateForm.ProductNumber"
                    style="width: 200px"
                    disabled
                  />
                </el-form-item>
              ...
              <div>
                ...
                <el-button
                  type="info"
                  v-if="operateForm.Status == '0'"
                  @click="openStart"
                  >开始备料</el-button
                >
                <el-button
                  type="success"
                  v-if="operateForm.Status == '1'"
    ...
    >
      ...
      >
        ...
        <el-form-item label="货架" prop="shelf_ids_list">
          <el-select
            v-model="startForm.shelf_ids_list"
            multiple
            collapse-tags
    ...
    >
      <el-form ref="firstFormRef" :model="firstForm" label-width="auto">
        <div
          class="flex justify-around border-2 border-dashed border-red-600 mb-3"
        >
